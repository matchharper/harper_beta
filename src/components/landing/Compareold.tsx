      ...
      <div className="mx-auto flex w-full max-w-[1040px] flex-col items-center">
        ...
        <Reveal>
          <div className="mt-14 grid w-full grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
              ...
              <div className="mt-6 overflow-hidden rounded-2xl border border-white/10 bg-[#0E1013]">
                ...
                <div className="space-y-3 px-4 py-4">
                  {[
                    ...
                    <div
                      key={label}
                      className="flex flex-col items-start gap-1 rounded-xl border border-white/5 bg-white/5 px-4 py-3 md:flex-row md:items-center md:justify-between"
                    >
            ...
            <div className="rounded-3xl border border-[#B4FF78]/20 bg-[#B4FF78]/5 p-5 md:p-7">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-6 overflow-hidden rounded-2xl border border-[#B4FF78]/15 bg-[#0B0E0A]">
                ...
                <div className="px-4 py-4">
                  ...
                  <div className="mt-4 space-y-2">
                    {[
                      ...
                      <div
                        key={item}
                        className="rounded-xl border border-[#B4FF78]/10 bg-[#B4FF78]/5 px-4 py-3 text-sm text-white/80"
                      >
                        {item}
                      </div>
                    ))}
                ...
                <div className="border-t border-[#B4FF78]/10 px-4 py-4">
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                    <div className="rounded-xl border border-[#B4FF78]/10 bg-[#B4FF78]/5 px-4 py-3 text-center">
                      <div className="text-[11px] text-white/40">Signals</div>
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 px-5 py-4 text-center text-sm leading-7 text-white/65 md:px-6 md:text-base">
