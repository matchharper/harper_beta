...
function PhoneFrame({
  ...
  return (
    <div
      className={[
        "relative rounded-[28px] border border-black/10 bg-[#F7F7F5] px-3 pb-3 pt-[52px]",
    ...
    >
      ...
      <div
        className={[
          "overflow-hidden rounded-[20px] border border-black/10 bg-white md:rounded-[28px]",
          bodyClassName,
        ].join(" ")}
      >
        {children}
...
function LinkedinInboxPhone() {
  return (
    <div className="absolute bottom-[-108px] left-1/2 z-10 w-[86%] max-w-[480px] -translate-x-1/2 md:bottom-[-58px] md:w-[70%]">
      <PhoneFrame>
        <div className="border-b border-black/10 bg-white px-3 py-3.5 md:px-5 md:py-4.5">
    ...
    <div className="absolute bottom-[-108px] left-1/2 z-10 w-[86%] max-w-[480px] -translate-x-1/2 md:bottom-[-64px] md:w-[70%]">
      <PhoneFrame className="bg-[#F8F8F6]">
        <div className="bg-white">
          ...
          <div className="border-y border-black/10 px-2 py-2 text-left text-[11px] font-normal text-[#232323] md:px-4 md:py-3 md:text-[13px]">
