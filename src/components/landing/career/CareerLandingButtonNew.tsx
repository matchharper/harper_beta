...
type CareerLandingButtonNewProps = {
  href?: string;
  label: string;
  size?: "sm" | "md";
...
export default function CareerLandingButtonNew({
  href,
  label,
  size = "md",
  variant = "primary",
  ...
  const classNames = `group relative inline-flex items-center justify-center overflow-hidden font-medium transition-colors duration-300 ${
    isPrimary
