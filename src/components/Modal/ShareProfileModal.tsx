      ...
      <div className="space-y-4">
        ...
        <label className="flex items-center gap-2 text-sm text-neutral-primary">
          {/* <input
                        ...
                        className="rounded border-neutral-700 bg-neutral-800 text-accent-300 focus:ring-primary/40"
                    /> */}
          <Checkbox
            checked={includeChat}
        ...
        <div className="rounded-xl bg-bg-basement p-3 text-sm text-neutral-primary">
        ...
        {url && (
          <div className="space-y-2 mt-1">
            <div className="text-xs text-neutral-soft flex flex-row items-center justify-between">
              <div>공유 링크</div>
              <BareButton
                onClick={copyUrl}
                className="text-xs text-neutral-soft hover:text-primary"
              >
                {isCopying ? "복사 중..." : "복사"}
              </BareButton>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex-1 break-all rounded-lg border border-neutral-1000-a05 bg-bg-basement p-2 text-sm text-neutral-primary">
                {url}
              </div>
            </div>
            {copied && <div className="text-sm text-positive">복사됨 ✓</div>}
          </div>
        )}

        {errorMsg && (
          <div className="rounded-lg bg-critical-faded p-2 text-sm text-critical">
            {errorMsg}
          </div>
        )}
      </div>
