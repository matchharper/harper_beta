...
export const CompanyEmptyState = ({
  ...
  if (activeTab === "following") {
    return (
      <div className="rounded-[8px] border border-beige900/10 bg-white/45 px-5 py-10 text-center">
        <Building2 className="mx-auto h-6 w-6 text-beige900/35" />
        <h3 className="mt-4 text-[16px] font-medium text-beige900">
          아직 팔로우한 회사가 없습니다.
        </h3>
        <p className="mx-auto mt-2 max-w-[520px] text-[13px] leading-6 text-beige900/60">
  ...
  return (
    <div className="rounded-[8px] border border-beige900/10 bg-white/45 px-5 py-10 text-center">
      <Sparkles className="mx-auto h-6 w-6 text-beige900/35" />
      <h3 className="mt-4 text-[16px] font-medium text-beige900">
        아직 추천 회사가 없습니다.
      </h3>
      <p className="mx-auto mt-2 max-w-[560px] text-[13px] leading-6 text-beige900/60">
