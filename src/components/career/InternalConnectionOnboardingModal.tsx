...
export default function InternalConnectionOnboardingModal({
  ...
  return (
    <TalentCareerModal
      open={open}
      onClose={onClose}
      title="연결 수락 전에 5분 커리어 인터뷰가 필요해요."
      description="내부 기회 연결은 회사에 회원님을 소개하고 추천하는 단계라, 회사에서 궁금해할만한 정보를 저에게 알려주셔야 이후 단계를 진행할 수 있어요."
    ...
    >
      <div className="space-y-4">
        ...
        >
          Harper와의 가벼운 대화로 생각해주세요. 짧게 이야기하면서 어떤 것들을
