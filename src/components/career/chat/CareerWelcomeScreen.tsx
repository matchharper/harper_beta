...
const CareerWelcomeScreen = () => {
  const { user, onboardingBeginPending, onUseChatOnly, onStartCallMode } =
        ...
        <div className="flex flex-1 flex-col justify-between gap-12">
          <div className="max-w-[820px]">
            <div className="mt-8 space-y-12">
              <div className="max-w-[760px] space-y-3 text-[16px] leading-8 text-beige900/65 sm:text-[17px]">
                <StaggerText
              ...
              <div className="grid max-w-[720px] gap-3 md:grid-cols-2">
                <CareerPrimaryButton
                  ...
                  disabled={onboardingBeginPending || !onStartCallMode}
                  className={careerCx(
