...
const CareerVoiceInputLevelFill = ({
  ...
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none absolute inset-y-0 left-0 bg-linear-to-r from-hblack200 via-hblack200 to-transparent transition-[width,opacity] duration-200"
      style={{
        width,
