export const en = {
  ...
  career: {
    ...
    "career.chat.career_call_screen.1l3ov75":
      "End call and end career interview early",
    ...
    "career.chat.career_message_bubble.0vdatv0":
      "I'll keep handling the connection with them.",
    "career.chat.career_message_bubble.0whsa78": "Call",
    "career.chat.career_message_bubble.1ac1x4s":
      "This isn't a required conversation, just a call to ask some questions that help with the connection. You don't have to join.",
    ...
    "career.common.career_flow_provider.06f4hcx":
      "Ended before the 6-hour HR stream was completed.",
    "career.common.career_flow_provider.0750gye":
      "Failed to generate 6-hour HR.",
    ...
    "career.common.career_flow_provider.request_more_open_positions":
      "Recommend more open positions for me.",
    ...
    "career.common.career_history_panel.0y27adb": "Connected",
    ...
    "career.common.career_history_panel.1aylp85": "Archive",
    ...
    "career.common.career_history_panel.1vrs10j": "Archived",
    ...
    "career.common.career_support_inquiry_modal.0mo6mro": "After confirmation",
    "career.common.career_support_inquiry_modal.0s26aoz": "I'll respond.",
    ...
    "career.common.career_workspace_screen.mobile_inbox": "Inbox",
    "career.common.career_workspace_screen.mobile_jobs": "Jobs",
    ...
    "career.common.opportunity_type_meta.03vuko5":
      "This note helps me adjust your next recommendations. You can submit without selecting anything. Keyboard selection is supported.",
    ...
    "career.common.opportunity_type_meta.0ume46n": "Applied/In Progress",
    ...
    "career.common.opportunity_type_meta.1q9hdqb":
      "Harper will use this note to adjust future recommendations and client matching.",
    ...
    "career.common.opportunity_type_meta.external_already_applied":
      "I've already applied to this company or role.",
    ...
    "career.history.history_oppotunity_info_modal.1ucb8t9":
      "If you change your mind after accepting, just let Harper know. If you select 'Archived,' we'll use the reason to reduce similar opportunities in future recommendations.",
    ...
    "career.history.opportunity_detail_content.add_memo": "Add memo",
    "career.history.opportunity_detail_content.company_source":
      "Company / Source",
    "career.history.opportunity_detail_content.edit_memo": "Edit memo",
    ...
    "career.history.opportunity_detail_content.internal_source":
      "Harper network",
    "career.history.opportunity_detail_content.memo": "My memo",
    "career.history.opportunity_detail_content.show_detail": "Show details",
    "career.history.opportunity_detail_content.source": "Source",
    ...
    "career.history.saved_opportunity_status.archived": "Archived",
    "career.history.saved_opportunity_status.0obqas2": "Saved",
    "career.history.saved_opportunity_status.0rjulen": "Applied/In Progress",
    "career.history.saved_opportunity_status.1jv953e": "Closed",
    ...
    "career.home.career_home_panel.0sdf230": "New Matches",
    ...
    "career.home.career_home_panel.11q0oj9": "Saved Matches",
    ...
    "career.home.career_mobile_home_view.0ao3c3d": "of",
    ...
    "career.onboarding.onboarding.0czo5rp":
      "Your career needs an<br />agent too.",
    ...
    "career.onboarding.onboarding.1njrwx4":
      "Name (Please write Korean names in Korean.)",
    ...
    "career.onboarding.onboarding_loading_state.profile_context":
      "I'm analyzing your experience and interests",
    ...
    "career.settings.career_settings_modal.0qqmxjm": "Back to Settings",
