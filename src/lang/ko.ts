    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "네, 신뢰할 수 있습니다. Harper의 AI는 추측하지 않고 증명합니다. 웹상에 실존하는, Public한 '검증 가능한 데이터'만을 기반으로 분석하기 때문입니다. 도출한 모든 인사이트에는 원본 출처가 함께 제공되므로 직접 체크가 가능합니다.",
        },
        {
    ...
    pricingFaq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "부분 환불은 제공되지 않습니다. 다만, 정당한 사유가 있는 경우에는 문의해 주시면 개별적으로 검토해 드리겠습니다.",
        },
      ],
    },
  },
