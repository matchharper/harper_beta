...
연간 구독의 경우, 구독 기간 중 취소 및 환불을 요청하시면 이미 사용한 개월 수를 월간 구독 요금 기준으로 계산한 후, 나머지 기간에 해당하는 금액을 환불해 드립니다.\n자세한 사항은 아래의 환불 규정을 확인해주세요.",
  ...
  career: {
    ...
    "career.api.pending_actions.fallback_company": "채용 회사",
    "career.api.pending_actions.fallback_role": "제안받은 포지션",
    ...
    "career.chat.career_composer_section.action_menu_upload_file_hint":
      "이력서/포트폴리오 등",
    "career.chat.career_composer_section.call_mode_aria_label": "통화 모드",
    "career.chat.career_composer_section.interview_progress_aria_label":
      "커리어 인터뷰 진행률",
    "career.chat.career_composer_section.opportunity_picker_count": "{count}개",
    ...
    "career.chat.career_composer_section.opportunity_picker_loading":
      "추천 기회를 불러오는 중",
    "career.chat.career_composer_section.opportunity_picker_title": "추천 기회",
    ...
    "career.chat.career_message_bubble.composing": "작성 중...",
    ...
    "career.chat.pending_action_context.collapse_aria": "요청 내용 접기",
    ...
    "career.chat.pending_action_context.resume_request_label":
      "회사 요청 · 이력서",
    "career.chat.pending_action_context.upload_resume": "이력서 업로드",
    "career.chat.tool.internal_role_priority_review.start":
      "포지션 우선 검토 요청을 처리하고 있습니다.",
    "career.chat.tool.list_documents.start": "저장된 문서를 확인하고 있습니다.",
    "career.chat.tool.open_url.start": "공유된 링크 내용을 확인하고 있습니다.",
    "career.chat.tool.read_document.start": "문서 내용을 확인하고 있습니다.",
    ...
    "career.common.opportunity_type_meta.16ujfch": "외부 기회",
    ...
    "career.common.opportunity_type_meta.1ebvtk6":
      "저장하기 전에 한 줄만 남겨주세요",
    "career.common.opportunity_type_meta.1gbs2on": "Harper 기회",
    ...
    "career.common.recommendation_search.blocking_running_title":
      "먼저 진행 중인 포지션 검색",
    "career.common.recommendation_search.completed_title": "요청하신 검색 완료",
    "career.common.recommendation_search.failed_detail":
      "이번 검색을 완료하지 못했어요. 잠시 뒤 다시 요청해 주세요.",
    "career.common.recommendation_search.failed_title": "검색을 완료하지 못함",
    ...
    "career.common.recommendation_search.partial_title":
      "검색 완료 · 일부 전달 문제",
    "career.common.recommendation_search.queued_title": "검색 대기 중",
    "career.common.recommendation_search.running_detail":
      "프로필과 이번 요청을 기준으로 공개 포지션을 선별하고 있어요. 검색 중에도 대화를 계속할 수 있습니다.",
    "career.common.recommendation_search.running_title": "포지션 검색 중",
    ...
    "career.email_change.verification.button": "새 이메일 인증하기",
    "career.email_change.verification.heading": "Harper 이메일 변경 인증",
    "career.email_change.verification.instruction":
      "아래 링크를 열어 새 이메일을 인증해주세요.",
    "career.email_change.verification.request_code": "요청 코드: {requestCode}",
    ...
    "career.history.internal_decision_actions.revert": "새 포지션으로 되돌리기",
    ...
    "career.history.internal_decision_actions.revert_reject_title":
      "거절을 되돌릴까요?",
    "career.history.internal_decision_actions.stop": "진행 중단하기",
    "career.history.internal_decision_actions.stop_confirm": "진행 중단하기",
    ...
    "career.history.opportunity_recommendation_preview.collapse": "접기",
    "career.history.opportunity_recommendation_preview.show_more": "더보기",
    ...
    "career.home.career_home_panel.0sdf230": "추천된 기회",
    ...
    "career.home.career_mobile_home_view.summary_count_label":
      "{count}개의 {label}",
    "career.home.internal_role_decision_banner.confirm": "확인하기",
    ...
    "career.profile.career_talent_profile_panel.0o1w258": "프로필 편집 작업",
    ...
    "career.profile.documents.resume_formats": "PDF, DOCX, TXT, MD · 최대 4MB",
    ...
    "career.profile.documents.gmail_history_edit_description": "Harper가 이메일에서 정리한 커리어 이력입니다. 필요한 내용을 직접 수정할 수 있습니다.",
    "career.profile.documents.gmail_history_edit_title": "Gmail 커리어 이력 수정",
    ...
    "career.profile.entry.company_linkedin_label": "회사 LinkedIn",
    "career.profile.entry.company_logo_choose": "로고 선택",
    "career.profile.entry.company_logo_label": "회사 로고",
    "career.profile.entry.company_logo_uploading": "업로드 중",
    ...
    "career.profile.resume_links.gmail_resync_confirm_action": "새로 분석",
    "career.profile.resume_links.gmail_resync_confirm_description": "현재 문서에서 직접 수정한 내용도 새 분석 결과로 대체됩니다.",
    "career.profile.resume_links.gmail_resync_confirm_help": "저장된 Gmail 커리어 이력 문서는 유지되지만 내용은 새 분석 결과로 덮어씁니다.",
    "career.profile.resume_links.gmail_resync_confirm_title": "Gmail 커리어 이력을 새로 분석할까요?",
    ...
    "career.profile.resume_links.gmail_connected_toast": "Gmail을 연결했습니다. 이제 Harper가 요청할 때 이메일을 조회할 수 있습니다.",
    ...
    "career.settings.career_settings_modal.account_email": "이메일",
    "career.settings.career_settings_modal.account_email_invalid":
      "유효한 이메일을 입력해주세요.",
    "career.settings.career_settings_modal.account_name": "이름",
    "career.settings.career_settings_modal.account_name_required":
      "이름을 입력해주세요.",
    "career.settings.career_settings_modal.account_save": "저장",
    ...
    "career.settings.career_settings_modal.external_recommendation_description":
      "Harper 사용 중에는 잘 맞는 외부 채용 공고를 주기적으로 찾아 알려드립니다.",
    ...
    "career.settings.career_settings_modal.pause_close_aria":
      "사용 중지 확인 닫기",
    "career.settings.career_settings_modal.pause_confirm": "사용 중지하기",
    ...
    "career.settings.career_settings_modal.subscription_updating": "변경 중",
    ...
    "career.settings.email_change.check_complete": "인증 완료 확인",
    ...
    "career.settings.email_change.new_email": "새 이메일",
    "career.settings.email_change.pending_description":
      "새 이메일로 전송된 인증 링크를 확인한 뒤 아래 확인 버튼을 눌러주세요.",
    "career.settings.email_change.resend": "인증 메일 재발송",
    "career.settings.email_change.resend_completed": "인증 메일 재발송 완료",
    ...
    "career.settings.email_change.save_failed":
      "인증된 이메일을 저장하지 못했습니다.",
    "career.settings.email_change.send": "인증 메일 보내기",
    ...
    "career.settings.email_change.title": "이메일 변경",
    ...
    "ui.1au199v": "서울시립대학교",
    "ui.1b3og5n": "한양대학교",
    "ui.1cv49jk": "어떤 방식이 편하신가요?",
    "ui.1gwajda": "선호 조건을 업데이트하고 싶어요.",
    "ui.1hgbu3p":
    ...
    "ui.1qgquty": "Harper와 통화하기",
    "ui.1qmlix7": "제 정보와 경험을 조금 더 자세히 이야기할 수 있어요.",
    "ui.1tk2q9m": "이화여자대학교",
    "ui.1w4hprp": "경희대학교",
