    ...
    pricingFaq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "네 원하신다면 언제든지 구독을 취소할 수 있습니다. 구독 취소의 경우 다음 결제주기 전까지는 기존 플랜으로, 보유중인 크레딧을 사용가능합니다. 이후에는 Free 플랜으로 전환되며 기존의 남은 크레딧 대신 10 크레딧이 채워집니다.",
        },
        {
          question: "크레딧은 언제 리필(초기화)되나요?",
          answer:
            "구독 즉시 크레딧이 충전됩니다. 월간 플랜은 결제 주기마다 리필되고, 연간 플랜은 구독 시작일 기준으로 매월 같은 날짜에 리필됩니다.\n리필시에는 기존에 남아있던 크레딧이 사라지고 새로운 크레딧이 채워집니다.",
        },
        {
...
다만 정당한 사유가 있는 경우 고객센터로 문의해 주시면 개별적으로 검토해 드립니다. 이 경우 결제하신 플랜과 남은 크레딧을 기준으로 환불 금액이 산정될 수 있습니다.\n\n \
