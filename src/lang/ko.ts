    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "네, 신뢰할 수 있습니다. Harper의 AI는 추측하지 않고 증명합니다. 공개적으로 접근 가능한 전문 정보(예: 공개 프로필, 오픈소스 기여 기록, 학술 발표 등)를 분석하여 구조화합니다. 도출한 모든 인사이트에는 원본 출처가 함께 제공되므로 직접 체크가 가능합니다.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Harper의 AI 엔진은 AI 리서처(AI Researcher)와 머신러닝 엔지니어(ML Engineer) 같은 고난이도 테크 인재 발굴에 가장 특화되어 있습니다.\n하지만 이에 국한되지 않고, 현재 PM 및 PD, 마케터 등 테크 조직 내 핵심 직군에 대해서도 검색이 가능합니다. 다양한 직군을 포함해 총 20만+개의 프로필을 가지고 있으며, 여기 포함된 직군은 찾을 수 있습니다. 매달 무료 검색 크레딧이 제공되니 편하게 사용하고 테스트해보세요.",
        },
      ],
    },
    closing: {
      ...
      items: [
        {
          ...
          answer:
            "네 Free plan의 경우 매달 10 크레딧이 충전됩니다. 제한되는 기능은 없고, 원하시는 기능을 10 크레딧만큼 사용하실 수 있습니다.",
        },
        {
          question: "언제든지 구독을 취소할 수 있나요?",
          answer:
            "네 원하신다면 언제든지 구독을 취소할 수 있습니다. 구독 취소의 경우 다음 결제주기 전까지는 기존 플랜으로, 보유중인 크레딧을 사용가능합니다. 이후에는 Free 플랜으로 전환되며 10 크레딧이 충전됩니다.",
        },
        {
          question: "크레딧은 언제 리필(초기화)되나요?",
          answer:
            "구독 즉시 크레딧이 충전됩니다. 월간 플랜은 결제 주기마다 리필되고, 연간 플랜도 구독 시작일 기준으로 매월 리필됩니다.\n리필시에는 기존에 남아있던 크레딧이 사라지고 새로운 크레딧이 채워집니다.",
        },
        {
          question: "추가 크레딧 구매나 플랜 변경이 가능한가요?",
          answer:
            "가능합니다. 추가 크레딧 요청 또는 플랜 업그레이드는 언제든 문의해 주세요. 채용 규모에 맞는 옵션을 안내해 드립니다.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "아쉽게도 부분 환불은 제공되지 않습니다. 다만, 정당한 사유가 있는 경우에는 문의해 주시면 개별적으로 검토해 드리겠습니다. 이 경우, 결제하신 플랜과 남은 크레딧을 비교하여 남은 크레딧 비용만큼 환불해드립니다.",
        },
      ],
    },
  },
