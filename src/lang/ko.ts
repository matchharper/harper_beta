      ...
      items: [
        {
          ...
          answer:
            "현재 Harper는 데이터 품질과 AI 리소스 최적화를 위해 Private Beta를 운영 중입니다. 올해 2분기(Q2) 정식 출시를 목표로 하고 있으며, 로그인 후 대기명단에 등록해 주시면 초대 코드를 발송해 드립니다.",
        ...
        },
        {
          ...
          answer:
            "Harper의 AI 엔진은 AI 리서처(AI Researcher)와 머신러닝 엔지니어(ML Engineer) 같은 고난이도 테크 인재 발굴에 가장 특화되어 있습니다.\n하지만 이에 국한되지 않고, 현재 PM(Product Manager) 및 PD(Product Designer), 마케터 등 테크 조직 내 핵심 직군에 대해서도 유의미한 검색과 프로파일링 기능을 이미 지원하고 있습니다. 다양한 직군을 포함해 총 200만+개의 프로필을 가지고 있으며, 여기 포함된 직군은 찾을 수 있습니다. 매달 무료 검색 크레딧이 제공되니 편하게 사용하고 테스트해보세요.",
        },
      ],
    },
    closing: {
