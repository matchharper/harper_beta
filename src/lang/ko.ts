...
연간 구독의 경우, 구독 기간 중 취소 및 환불을 요청하시면 이미 사용한 개월 수를 월간 구독 요금 기준으로 계산한 후, 나머지 기간에 해당하는 금액을 환불해 드립니다.\n자세한 사항은 아래의 환불 규정을 확인해주세요.",
  ...
  career: {
    ...
    "career.common.career.0kn6r0x":
      "펀딩, 채용, 팀 변화, 사업 성과 등 의미 있는 변화를 찾아서 알려드립니다.",
    "career.common.career.0m1nksm": "회사 측 채널 열림",
    ...
    "career.common.career.0yu4vbj": "업로드 예정:",
    ...
    "career.common.career.1bb9alt": "시그널 자동 추적",
    ...
    "career.common.career_history_panel.0y27adb": "연결됨",
    ...
    "career.common.career_history_panel.1h65j93":
      "새로 받은 기회를 모두 검토했습니다.",
    "career.common.career_history_panel.1hsndwk": "종료됨",
    ...
    "career.common.career_history_panel.1vrs10j": "제외됨",
    ...
    "career.common.career_hook_messages.09wz9hs": "참고 링크: {link}",
    ...
    "career.common.career_support_inquiry_modal.0au4clq":
      "아래에서 자유롭게 작성해주세요.",
    "career.common.career_support_inquiry_modal.0mo6mro": "확인 후",
    ...
    "career.common.opportunity_type_meta.0ume46n": "지원함/진행중",
    ...
    "career.company.company_card.17aqd6f": "회사 정보를 정리 중입니다.",
    ...
    "career.company.company_card.1qxewwj": "추천 근거",
    ...
    "career.company.company_empty_state.08icf7j": "아직 추천 회사가 없습니다.",
    ...
    "career.company.company_empty_state.0h6kux1":
      "추천회사나 포지션 히스토리에서 회사 정보를 열고 팔로우하면 이곳에서 채용, 펀딩, 팀 변화 같은 업데이트를 추적합니다.",
    "career.company.company_empty_state.0s75w2v": "추천 회사 만들기",
    ...
    "career.company.watchlist_types.0dpjqlp": "추천회사",
    ...
    "career.history.opportunity_detail_content.external_source": "외부 채용공고",
    ...
    "career.history.opportunity_detail_content.source": "출처",
    ...
    "career.history.saved_opportunity_status.archived": "제외됨",
    "career.history.saved_opportunity_status.0obqas2": "저장됨",
    "career.history.saved_opportunity_status.0rjulen": "지원함/진행중",
    "career.history.saved_opportunity_status.1jv953e": "종료됨",
    ...
    "career.home.career_home_panel.11q0oj9": "저장 / 연결",
    ...
    "career.home.career_mobile_home_view.0ao3c3d": "개의",
    ...
    "career.home.career_mobile_home_view.1vip5ub": "저장/연결된 기회",
    ...
    "career.kickoff.fallback_name": "회원",
    ...
    "career.kickoff.system_prompt.acknowledgement_example": "안녕하세요 OO님.",
    ...
    "career.profile.career_profile_menu.14ybad0": "업데이트 노트",
    ...
    "career.settings.career_settings_modal.0qqmxjm": "설정 메뉴로 돌아가기",
