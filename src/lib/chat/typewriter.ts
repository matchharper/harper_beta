...
/**
 * Splits visible chat text without losing whitespace or Markdown characters.
 * Both Career and Organization use this for progressive assistant rendering.
 */
export function buildChatTypewriterChunks(
  content: string,
