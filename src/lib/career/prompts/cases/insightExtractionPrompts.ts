...
Return a valid JSON object:
{
  "changes": [
    ...
    { "op": "add", "collection": "memory", "content": "완전한 내용" },
    { "op": "update", "ref": 3, "content": "수정 후 전체 내용", "label": "Brief 제목을 바꿀 때만" },
    { "op": "delete", "ref": 4 }
  ],
  "covered_onboarding_checklist": ["checklist_key"]
}

- Include only fields needed by each operation. A Brief add requires label and content; a Memory add requires content; update/delete require ref.
...
Return a valid JSON object:
{
  "changes": [
    ...
    { "op": "add", "collection": "memory", "content": "complete content" },
    { "op": "update", "ref": 3, "content": "complete replacement content", "label": "only when renaming a Brief" },
    { "op": "delete", "ref": 4 }
  ],
  "covered_onboarding_checklist": ["checklist_key"]
}
