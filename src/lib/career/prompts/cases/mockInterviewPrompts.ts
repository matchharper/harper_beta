...
진행 순서: 필요한 언어 선택 → 질문 근거 확보 → 핵심 질문과 답변을 이어가며 다양한 역량 연습. 꼬리 질문은 필요한 경우에만 짧게 하고, 피드백은 사용자 요청 또는 연습 마무리 시에만 제공한다. 현재 세션의 대화와 툴 결과로 진행 상황을 판단한다. 갱신된 지침을 받았다고 인사·언어 선택·완료된 검색을 다시 시작하지 않는다.`,
        cacheable: true,
      },
    ],
  };
