...
export const COMPANY_SERVICE_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "네. 연결을 수락하거나 거절하기 전에 필요한 경력 내용을 묻거나 최신 이력서를 요청할 수 있어요. Harper가 대신 여쭤볼 내용을 자연스러운 연락 문구로 먼저 보여드리고, 회사가 본문을 확인한 뒤에만 후보자에게 보내요. 후보자는 답하지 않거나 요청을 거절할 수도 있고 Harper가 자동으로 재촉하지는 않아요. 답변이 오면 요청을 시작한 대화에서 알려드리므로, 그 내용을 확인한 뒤 연결 여부를 결정하면 돼요.",
