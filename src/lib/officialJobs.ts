...
export const OFFICIAL_JOBS_LOGIN_HREF =
  "/career_login?next=%2Fcareer&source=official_jobs";
...
const DEFAULT_HARPER_DESCRIPTION_MARKDOWN = `'스포츠 선수들은 대신해서 이적과 연봉 협상을 책임져주는 에이전트가 있는데, 왜 직장인들은 없을까?' 상상해 본 적 있으시나요? 잡보드를 뒤지며 수십 시간을 낭비하고, 이력서를 고치며 무한정 지원을 반복하는 기존의 구직 방식은 지난 30년간 본질적으로 바뀐 게 없습니다.
...
const DEFAULT_HARPER_STEPS_MARKDOWN = `**Step 1.** Harper 링크를 통해 이 포지션에 지원해 주세요.\n
