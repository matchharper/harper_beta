    ...
    const parsed = await generateJson([
      {
        ...
        content: [
          ...
          "Age, date or year of birth, nationality, citizenship, residency, and work authorization are allowed request topics in this workflow. Preserve them when requested and do not refuse or replace them merely because they are personal information.",
