...
const companyRequests: CompanyRequest[] = [
  ...
  },
  {
    ...
    compensation: "Average : $ 350k - 500k (equity 포함)",
  },
  {
    id: "fde",
...
const faqs = [
  ...
  },
  {
    ...
    answer: `<div className="w-[90%] md:w-[60%] text-center mt-32 mb-4">
              <div>
                ※ Harper는 회사 편에 서서 기계적인 스팸을 보내는 기존 헤드헌팅의 한계를 풀고자 합니다. Harper는 오직 '후보자를 위한' 전담 AI 헤드헌터로서, 대화를 통해 여러분의 정확한 니즈를 파악하고 여러분의 커리어 가치를 극대화할 수 있는 최고의 기회만을 엄선해 매칭해 드립니다.
              </div>
              <div>
                <br />
