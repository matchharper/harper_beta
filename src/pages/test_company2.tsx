...
const logos = [
  ...
  { src: YONSEI_LOGO_SRC, name: "Yonsei University", width: 42 },
  ...
  { src: "/images/logos/kakao.svg", name: "Kakao", width: 62 },
  { src: "/svgs/cohere.svg", name: "Cohere", width: 82 },
  { src: "/images/logos/amazon.svg", name: "Amazon", width: 66 },
  ...
  { src: "/images/logos/samsung.svg", name: "Samsung", width: 98 },
] as const;
              ...
              <form onSubmit={submitForm} className="mt-7 space-y-4">
                <label className={labelClass}>
                  ...
                  <input
                    ...
                    className={cn(inputClass, "border-neutral-950")}
              ...
              <div>
                ...
                <div className="mt-6 grid grid-cols-3 gap-2 sm:grid-cols-4 md:mt-8">
                  {logos.map((logo) => (
                    <div
                      key={logo.name}
                      className="group flex h-[72px] items-center justify-center rounded-sm border border-neutral-200 bg-neutral-200/80 px-3 md:h-24 md:px-4"
                    >
                      <span
                        className="relative block h-7 max-w-full opacity-75 grayscale transition group-hover:opacity-100 group-hover:grayscale-0 md:h-8 md:max-w-[166px]"
              ...
              <div className="flex min-w-0 flex-col">
                ...
                <div className="mt-6 flex flex-1 flex-col md:mt-8">
                  <div className="flex w-full flex-col gap-2">
                    ...
                    <p className={fontMedium}>
                      <span className="text-primary">Sequoia-backed</span>{" "}
                      Consumer AI Agent
                    </p>
                  ...
                  <div className="mt-8 flex min-h-[220px] w-full flex-col items-start justify-between rounded-sm border border-neutral-200 bg-neutral-200/80 p-5 md:mt-auto md:min-h-[240px]">
