      ...
      <main className="flex-1 flex relative font-sans items-center justify-center px-6 w-full pt-[25vh]">
        <div className="absolute top-2 right-2 flex flex-row items-end gap-2">
          ...
          <button
            ...
            className="cursor-pointer hover:bg-white/10 transition text-[11px] text-hgray900 px-3 py-1.5 rounded-full bg-white/5 font-normal flex flex-row items-center gap-2"
          >
