...
function resolveDocumentLanguage(props: DocumentProps) {
  const pageProps = props.__NEXT_DATA__.props.pageProps as
    | { locale?: unknown }
    | undefined;

  return pageProps?.locale === "en" ? "en" : "ko";
}

export default function Document(props: DocumentProps) {
  return (
    <Html
      lang={resolveDocumentLanguage(props)}
