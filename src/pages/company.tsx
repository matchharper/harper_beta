...
const ComparisonCard = ({
  ...
  <PlaceholderShell
    className={`relative h-[340px] p-10 max-[1199px]:h-[320px] max-[809px]:min-h-0 max-[809px]:p-7 ${className || ""}`}
    style={style}
  >
      ...
      <div className="space-y-4 text-lg leading-[1.42] tracking-normal max-[809px]:text-[16px] text-white/90">
        {items.map((item) => (
          <div key={item} className="flex flex-row items-center gap-2">
            {isPositive ? (
              <Check size={16} className="min-w-[16px]" />
            ) : (
              <X size={16} className="min-w-[16px]" />
            )}
            <p>{item}</p>
          </div>
        ))}
...
const Beige = () => {
  ...
  const {
    closeModal: closeMeetingRequestModal,
    form: meetingRequestForm,
    isOpen: isMeetingRequestOpen,
    isSubmitting: isMeetingRequestSubmitting,
    openModal: openMeetingRequestModal,
    submitForm: submitMeetingRequestForm,
    updateForm: updateMeetingRequestForm,
  } = useCompanyMeetingRequestModal({
    locale,
  ...
  return (
    <>
      ...
      <CompanyMeetingRequestModal
        ...
        onSubmit={submitMeetingRequestForm}
      />
          ...
          >
            ...
            >
              <Reveal once direction="left" className="pr-4 max-[1199px]:pr-0">
                ...
                <p className="mt-8 max-w-[540px] text-[20px] leading-normal tracking-[-0.03em] text-beige900/50 max-[809px]:text-[18px]">
                  ...
                  filtering with high-precision matching for your most critical
                  AI/ML roles.
                </p>
                <div className="mt-10">
                  <CalendlyButton
            ...
            >
              ...
              <Reveal direction="right" delay={0.08}>
                <div className="relative p-4 md:p-7 overflow-hidden rounded-[32px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(196,168,255,0.18),transparent_24%),radial-gradient(circle_at_72%_22%,rgba(255,222,173,0.16),transparent_18%),linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] shadow-[0_26px_80px_rgba(0,0,0,0.28)]">
  ...
  return (
    <div className="mt-10 self-start max-w-[740px] text-sm tracking-[-0.03em] w-full flex flex-col md:flex-row items-start md:items-stretch justify-between py-10 md:py-8 gap-6 md:gap-0">
      <div className="flex flex-1 flex-col items-start justify-start gap-4 md:gap-6 text-beige900/70">
        ...
        <div className="text-[13px] flex flex-row items-center gap-2">
          <div>사람을 찾고 계신가요?</div>
          <div
            onClick={() =>
              onClickStart
        ...
        <div className="text-[13px] flex flex-col items-start justify-start gap-0">
          <div>상호명 : 주식회사 하퍼</div>
