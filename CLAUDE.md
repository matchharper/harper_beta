...
- **voice** — career voice runs through OpenAI Realtime over WebRTC, with ElevenLabs TTS as an optional playback path (`hooks/career/useRealtimeSession.ts`, `lib/tts/`)
